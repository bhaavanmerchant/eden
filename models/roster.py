...
db.hrm_person_role.update_or_insert(job_role_id='1', person_id='2')
db.hrm_person_role.update_or_insert(job_role_id='1', person_id='3')
db.hrm_person_role.update_or_insert(job_role_id='1', person_id='4')
db.hrm_person_role.update_or_insert(job_role_id='1', person_id='5')
db.hrm_person_role.update_or_insert(job_role_id='1', person_id='6')
db.hrm_person_role.update_or_insert(job_role_id='2', person_id='4')
db.hrm_person_role.update_or_insert(job_role_id='2', person_id='5')
db.hrm_person_role.update_or_insert(job_role_id='2', person_id='6')
db.hrm_person_role.update_or_insert(job_role_id='2', person_id='7')
db.hrm_person_role.update_or_insert(job_role_id='2', person_id='8')
db.hrm_person_role.update_or_insert(job_role_id='2', person_id='1')
db.hrm_person_role.update_or_insert(job_role_id='3', person_id='1')
db.hrm_person_role.update_or_insert(job_role_id='3', person_id='6')
db.hrm_person_role.update_or_insert(job_role_id='3', person_id='7')
db.hrm_person_role.update_or_insert(job_role_id='3', person_id='8')
db.hrm_person_role.update_or_insert(job_role_id='3', person_id='9')
db.hrm_person_role.update_or_insert(job_role_id='3', person_id='10')
...
db.project_project.update_or_insert(organisation_id='1',name='Project Alpha',code='Project Alpha',description='sad',start_date='2012-08-04',end_date='2012-08-23',currency='USD')
db.project_project.update_or_insert(organisation_id='2',name='Project Beta',code='Project Beta',description='',start_date='2012-07-14',end_date='2012-08-23',currency='USD')
db.project_project.update_or_insert(organisation_id='2',name='Project Gamma',code='Project Gamma',description='',start_date='2012-08-01',end_date='2012-09-23',currency='USD')
db.project_project.update_or_insert(organisation_id='2',name='Project Delta',code='Project Delta',description='',start_date='2011-08-04',end_date='2011-08-23',currency='USD')
db.project_project.update_or_insert(organisation_id='3',name='Project Epsilon',code='Project Epsilon',description='',start_date='2012-02-21',end_date='2012-08-23',currency='USD')
